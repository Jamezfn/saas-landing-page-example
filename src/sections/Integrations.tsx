...
import IntergrationCol from "@/components/IntergrationCol";
            ...
            <div className="container">
                <div className="lg:grid lg:grid-cols-2 lg:items-center lg:gap-16">
                    <div>
                        ...
                        <p className="text-foreground/50 mt-4 text-lg">Layers seamlessly connects with your favourite tool, making it easy to plug into any workflow and collaborate across platforms.</p>
                    </div>
                    <div>
                        <div className="h-100 lg:h-200 mt-8 lg:mt-0 overflow-hidden md:grid md:grid-cols-2 md:gap-4 mask-[linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]">
                            <IntergrationCol integrations={integrations}/>
                            <IntergrationCol integrations={integrations.slice().reverse()} className="hidden md:flex"/>
                        </div>
                    </div>
                </div>
            </div>
